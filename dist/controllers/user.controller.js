...
const updateProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedUser = yield userService.updateUserProfile(req.user.id, req.body, req.file);
...
const followUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield userService.followUser(req.user.id, req.params.userId);
...
const unfollowUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield userService.unfollowUser(req.user.id, req.params.userId);
        res.status(200).json(data);
    }
    catch (err) {
        next(err);
